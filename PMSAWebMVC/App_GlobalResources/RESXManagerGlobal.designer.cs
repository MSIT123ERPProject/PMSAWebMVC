...
namespace Resources {
    ...
    internal class RESXManagerGlobal {
        ...
        /// <summary>
        ///   查詢類似 You have added/removed &quot;##SelectedCultureFullName##&quot; resource files. Because you are running in Medium trust mode or below, please go to &lt;span style=&quot;color:red;&quot;&gt;ROOT_OF_YOUR_SITE\\config\\RESXManager.config&lt;/span&gt; file and add/remove the following entry manually:
        ///&lt;br/&gt;
        ...
        ///&lt;br/&gt;
        ///Note that different cultures in &lt;span style=&quot;co [字串的其餘部分已遭截斷]&quot;; 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 You are running in Medium trust mode or below 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 You have modified the data entry fields since last savings. If you leave this page, any changes will be lost. To save these changes, click Cancel to return to the page, and then Save the data. 的當地語系化字串。
        /// </summary>
